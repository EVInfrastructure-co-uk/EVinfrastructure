function populate(slug) {
  ...
  .then(jsonDatadata => {
    ...
    document.getElementById('channel-annual-fee-district').innerHTML = district['channel-annual-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-manufacturer-district').innerHTML = district['channel-manufacturer'];
    document.getElementById('LEVI-capital-amount-district').innerHTML = district['LEVI-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('LEVI-pilot-capital-amount-district').innerHTML = district['LEVI-pilot-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('channel-grant-amount-county').innerHTML = county['channel-grant-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-application-fee-county').innerHTML = county['channel-application-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-installation-fee-county').innerHTML = county['channel-installation-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-annual-fee-county').innerHTML = county['channel-annual-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-manufacturer-county').innerHTML = county['channel-manufacturer'];
    document.getElementById('LEVI-capital-amount-county').innerHTML = county['LEVI-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('LEVI-pilot-capital-amount-county').innerHTML = county['LEVI-pilot-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('channel-grant-amount-CA).innerHTML = ca['channel-grant-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-application-fee-CA).innerHTML = ca['channel-application-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-installation-fee-CA).innerHTML = ca['channel-installation-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-annual-fee-CA).innerHTML = ca['channel-annual-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-manufacturer-CA).innerHTML = ca['channel-manufacturer'];
    document.getElementById('LEVI-capital-amount-CA).innerHTML = ca['LEVI-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('LEVI-pilot-capital-amount-CA).innerHTML = ca['LEVI-pilot-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('channel-grant-amount-unitary').innerHTML = unitary['channel-grant-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-application-fee-unitary').innerHTML = unitary['channel-application-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-installation-fee-unitary').innerHTML = unitary['channel-installation-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-annual-fee-unitary').innerHTML = unitary['channel-annual-fee'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    document.getElementById('channel-manufacturer-unitary').innerHTML = unitary['channel-manufacturer'];
    document.getElementById('LEVI-capital-amount-unitary').innerHTML = unitary['LEVI-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
    ...
    document.getElementById('LEVI-pilot-capital-amount-unitary').innerHTML = unitary['LEVI-pilot-capital-amount'].toLocaleString("en-GB", {style:"currency", currency:"GBP"});
